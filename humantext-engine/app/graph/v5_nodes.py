...
def generate_node(state: HumanizerState) -> Dict[str, Any]:
    ...
    prompt = (
        ...
        "3. NO FORMULAIC SUMMARIES: NEVER use colons like 'on an important topic: Topic Name'. NEVER use generic field definitions ('X is a crucial field that covers a lot, from Y to Z').\n"
        "4. NO REPETITIVE IT'S ALL ABOUT: NEVER repeat 'It's all about...' or 'It's everywhere - [list]'. Vary the grammatical subjects across sentences.\n"
        "5. NO 3- TO 5-ITEM BROCHURE LISTS: Avoid lists like 'education, medicine, business, and even entertainment' or 'software dev, web dev, cybersecurity, data science, and AI'. Summarize the point naturally.\n"
        "6. NO CORPORATE CLOSINGS: NEVER write 'Thanks, [Name], for sharing your valuable knowledge and experience'. Conclude naturally like a human.\n"
        "7. ABSOLUTELY NO HASHTAGS: Do NOT include any hashtags (#...) anywhere in your output.\n"
        "8. NO AI CLICHES: Never use words like 'enlightening', 'delved into', 'fostering', 'robust', 'lifeline', 'in essence', 'in conclusion', 'in closing', 'invaluable', 'testament', 'tapestry', 'in today's world'.\n"
    )
    if facts_str:
        prompt += f"9. RETAIN CORE FACTS EXACTLY: {facts_str}\n"
    if citations_str:
        prompt += f"10. PRESERVE CITATIONS: {citations_str}\n"
